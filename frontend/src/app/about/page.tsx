...
export const metadata: Metadata = {
  ...
  description:
    "이름의 결은 미학 우선·사전 충실형 한자·유행 배제·투명한 알고리즘 네 가지 원칙으로 한국어 이름을 추천합니다. 9,190자 한자 사전과 미학 70% + 조화 30% 공식으로 만든 이유를 소개합니다.",
...
const VALUES = [
  ...
  },
  {
    icon: BookOpen,
    title: "사전 충실형 한자",
    body: "9,190자의 한자 사전을 기반으로 합니다. 의미 없는 한자는 배제하고, 실제 인명에 쓰이는 한자의 뜻·오행·획수를 검수했습니다.",
  },
  {
    icon: Feather,
    title: "유행 배제",
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            이름의 결(이름의결 · namingkyeol)은 한 명의 개발자가 취미로 시작한 프로젝트입니다.
            학술적 작명론이나 특정 역술 유파를 대변하지 않으며,
            완성도 높은 제품을 목표로 지속적으로 개선 중입니다.
            이름이 비슷한 &lsquo;이름결&rsquo; 작명소·앱과는 관련이 없습니다.
            오류나 제안이 있으면{" "}
            <a
              href="/contact"
